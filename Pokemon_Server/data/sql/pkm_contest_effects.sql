...
(27, 2, 0, 'The appeal works great if performed first.', 'If user appeals first this turn, earns six points instead of two.'),
(28, 2, 0, 'The appeal works great if performed last.', 'If user appeals last this turn, earns six points instead of two.'),
(29, 1, 0, 'The appeal works well if the user''s condition is good.', 'If user has no stars, earns one point; if one, three points; if two, five points; if three, seven points.  This does not include the appeal point bonus the stars give.'),
